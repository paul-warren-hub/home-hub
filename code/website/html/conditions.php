<?php
	...
	echo('<div style="border: 1px solid black;padding: 3px;">');
		...
		echo('<input type="radio" name="condType" value="newTimeDiv" onchange="expose(this);" />&nbsp;Time-based<br />');

		if ($_SESSION['userrole'] != 'occupant') {

			echo('<input type="radio" name="condType" value="newSimpleDiv" onchange="expose(this);" />&nbsp;Sensor-based<br />');
			echo('<input type="radio" name="condType" value="newComplexDiv" onchange="expose(this);" />&nbsp;Complex<br />');
		}
		echo('<br /><br />');
